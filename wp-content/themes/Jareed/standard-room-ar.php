<?php
/*
 * Template Name: Standard Room Arabic
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center">
                    <div class="room-details-container">
                        ...
                        <p>
                        تقدّم لك هذه الغرفة مفهومًا جديدًا للراحة المطلقة. حيث تدمج ما بين التصميم العصري والتفاصيل الفخمة لتبتكر
    البيئة المثالية التي تتوق للعودة إليها بعد يوم عملٍ طويل .
                        </p>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                            <ul>
                                                ...
                                                <li>الإطلالة: لا تتوفر إطلالة محددة،</li>
                                            </ul>
                                    </div>
                                    <div class="col">
                                        <ul>
                                                <li>تتوفر جلسة خارجية خاصّة</li>
                                                <li>المساحة: 52 م 2</li>
                        ...
                        <div class="row" style="height:100%;">
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 d-block justify-content-center align-items-center">
                                ...
                                <div class="row overview justify-content-center align-items-center">
                                    ...
                                    <ul>
                                            <li>
                                            الحد الأقصى المسموح به للأسرّة
    الإضافية: سرير إضافي -قابل
    للطيّ- أو سرير الطفل
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                            ثلاجة صغيرة مجهزة بالكامل مع
    مشروبات مجانية
                                            </li>
                                            <li>
                                            آلة صنع القهوة، مع أدوات إعداد
    الشاي
                                            </li>
                                            <li>
                                            هاتف لاسلكي
                                            ...
                                            <li>
                                            على الحائط والمكتب USB منافذ
    لشحن أجهزة متعددة
                                            </li>
                                            <li>
                                            تلفاز 65 بوصة مع توفر خدمات
    البث
                                            </li>
                                            <li>
                                            مكبر صوت بلوتوث مع منبّه، من
    علامة أوليفر هيمنج
                                            </li>
                                            <li>
                                            خزنة آمنة
