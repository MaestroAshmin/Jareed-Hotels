...
<div class="" style="background-color:#f1f1f2">
      <div class="room-banner">
         <div id="boulevard-room-slide" class="carousel slide" data-interval="5000" data-ride="carousel">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center">
                <div class="room-details-container">
                    <div class="room-name"><h2>FAMILY SUITE</h2></div>
                    ...
                    <div class="at-a-glance">
                        <div class="content">
                            ...
                            <div class="row">
                                <div class="col">
                                        <ul>
                                            <li>Sleeps up to 5 adults and 2 children</li>
                                            <li>2 bedrooms - 1 king room and 1 twin room</li>
                                            <li>Separate living and dining area, seats 6</li>
                                            <li>Powder Room</li>
                                            <li>Size: 164 m2</li>
                                        </ul>
                                </div>
                                <div class="col">
                                    <ul>
                                            <li>Dedicated butler room with bathroom and service kitchen</li>
                                            <li>View: Full city and Boulevard view with private terrace, outdoor sitting area for 6, dining area for 4</li>
                            ...
                            <div class="row overview justify-content-center align-items-center">
                                <div class="room-full-description">
                                   <ul>
                                        ...
                                        <li>
                                           Three 65” Smart TV with streaming services
                                        </li>
                                        <li>
