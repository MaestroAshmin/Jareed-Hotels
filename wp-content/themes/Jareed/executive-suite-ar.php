<?php
/*
 * Template Name: Executive Suite Arabic
          ...
          <div class="room-banner">
            <div id="boulevard-room-slide" data-interval="5000" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" style="height:450px;">
                    ...
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/StS 1.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/StS 2.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/StS 3.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/StS 4.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/StS 5.jpg" alt="Second slide">
                    </div>
                </div>
            </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center">
                <div class="room-details-container">
                    <div class="room-name"  style="letter-spacing:normal;"><h2>الجناح التنفيذي | إكسيكتف</h2></div>
                    <div class="room-description">
                    <p>
                    في الجناح التنفيذي يمكنك الحصول على كلّ ما تحلم به، فهو المكان الهادئ الذي تتوق للنوم فيه، وهو المحطّة المثالية للعمل والترفيه.
اعمل، استمتع، استرخِ قدر ما تشاء، فهذه هي الرفاهية المُطلقة!
                    ...
                    <div class="at-a-glance">
                        <div class="content">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <ul>
                                            <li>الإطلالة: لا يوجد إطلالة، مع مساحة خارجية صغيرة</li>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 d-block justify-content-center align-items-center">
                            ...
                            <div class="row overview justify-content-center align-items-center">
                                <div class="room-full-description">
                                   <ul>
                                        <li>
                                           الحد الأقصى المسموح به للأسرّة الإضافية: سرير إضافي -قابل للطيّ- وسرير للطفل
                                        </li>
                                        <li>
