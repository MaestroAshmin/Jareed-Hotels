           ...
           <div id="boulevard-room-slide" data-interval="5000" class="carousel slide" data-ride="carousel">
               <ol class="carousel-indicators">
                ...
                <div class="carousel-inner" style="height:450px;">
                    ...
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/bvr 1.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/bvr 2.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/bvr 3.jpg" alt="Third slide">
                    </div>
                    <div class="carousel-item">
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/bvr 4.jpg" alt="Third slide">
                    </div>
                </div>
            </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center">
                <div class="room-details-container">
                    <div class="room-name"><h2>BOULEVARD VIEW ROOM</h2></div>
                            ...
                            <div class="row">
                                <div class="col">
                                        <ul>
                                            ...
                                            <li>View: Full city and Boulevard view with private balcony</li>
                                        </ul>
                                </div>
                                <div class="col">
                                    <ul>
                    ...
                    <div class="readmore" data-aos="fade-up">
                        <button type="button" class="btn book-btn">BOOK THIS NOW</button>
                    </div>
                </div>
            </div>
        </div>
