...
<?php require 'header.php';?>
    ...
    <section id="spa-wellness-page" style="padding-top:0px;margin-top:135px; padding-bottom:50px;background-color:#f1f1f2;"">
        <div class="spa-wellness container-fluid" style="padding-bottom:0px !important;">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center" data-aos="fade-up">
                    ...
                    <div class="small-title" style="color:#4b555c;">Rest. Train. Groom</div>
                    ...
                    <div class="spa-image">
                        <div id="jimamCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                <img src="<?php echo get_template_directory_uri() ?>/images/SPA-4.jpg" class="img-fluid" alt="" data-aos="fade-up">  
                                </div>
                            </div>
                        </div>
                ...
                <div class="content col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="arena-image">
                        <div id="arenaCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                       <img src="<?php echo get_template_directory_uri() ?>/images/Arena 1.jpg" class="img-fluid" alt="" data-aos="fade-up">   
                                </div>
                                <div class="carousel-item">
                                       <img src="<?php echo get_template_directory_uri() ?>/images/Arena 2.jpg" class="img-fluid" alt="" data-aos="fade-up">   
                                </div>
                                <div class="carousel-item">
                                       <img src="<?php echo get_template_directory_uri() ?>/images/Arena 3.jpg" class="img-fluid" alt="" data-aos="fade-up">   
                                </div>
                            </div>
                        </div>
        ...
        <!-- March 25 -->
        <!-- <div class="spa-wellness barber container-fluid" style="padding-bottom:0px;">
                    ...
                    <div class="barbershop-image">
                        <div id="barbershopCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                                        <img src="<?php echo get_template_directory_uri() ?>/images/BARBER 3.jpg" class="img-fluid" alt="" data-aos="fade-up">    
