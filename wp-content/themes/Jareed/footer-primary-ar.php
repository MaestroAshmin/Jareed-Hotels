    ...
    <div class="footer-links">
        ...
        <div class="links col-md-1 col-lg-1 col-sm-1 mb-4 mb-md-0">
            <ul class="list-unstyled">
                <li>
                    <a href="<?php echo site_url();?>/about-us-ar" class="title">تواصل معنا</a>
                </li>
                <br>    
                <li>
        ...
        <div class="links col-md-1 col-lg-1 col-sm-1 mb-4 mb-md-0" >
            <ul class="list-unstyled">
            <li>
                <a href="<?php echo site_url();?>/rooms-&-suites-ar"  class="title">الغرف والأجنحة</a>
            </li>
            <br> 
            <li>
                <a href="<?php echo site_url();?>/rooms-&-suites-ar"  class="title">الغرف</a>
            </li>
            <li>
            ...
            <br>
            <li>
                <a href="<?php echo site_url();?>/rooms-&-suites-ar"  class="title">الأجنحة</a>
            </li>
            <li>
        ...
        <div class="links col-md-1 col-lg-1 col-sm-1 mb-4 mb-md-0">
            <ul class="list-unstyled">
            <li>
                <a href="<?php echo site_url();?>/home-ar#packages"  class="title">الباقات</a>
            </li>
            <br> 
            <li>
        ...
        <div class="links col-md-1 col-lg-1 col-sm-1 mb-4 mb-md-0">
            <ul class="list-unstyled">
            <li>
                <a href="<?php echo site_url();?>/spa-wellness-ar"  class="title">السبا ووسائل العناية بالصحة</a>
            </li>
            <br> 
            <li>
