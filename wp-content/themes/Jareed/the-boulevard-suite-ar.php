<?php
/*
 * Template Name: Boulvard Suite Arabic
        ...
        <div class="room-banner">
         <div id="boulevard-room-slide" data-interval="5000" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" style="height:450px;">
                    ...
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/BS 1.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/BS 2.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/BS 3.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/BS 4.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/BS 5.jpg" alt="Second slide">
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center">
                <div class="room-details-container">
                    <div class="room-name"  style="letter-spacing:normal;"><h2>جناح البوليڤارد</h2></div>
                    <div class="room-description">
                    <p>
                    نجعلُ من زيارتك للرياض تجربة لا تُنسى. ففي هذا الجناح يمكنك الاستمتاع بالمنظر الأخّاذ وأنت مسترخٍ في سريرِك، أو أثناء تناولك للوجبات الشهية رفقة أصدقائك وعائلتك في مساحات داخلية وخارجية مصممة بشكلٍ فريد.
                    </p>
                    <p>
                      نُفصّل لك تجربة استثنائية لتعيش أجمل لحظات حياتك، وتتمتّع بأقصى حدود الراحة والرفاهية.
                    </p>
                    </div>
                    ...
                    <div class="at-a-glance">
                            <div class="content">
                                ...
                                <div class="row">
                                    <div class="col">
                                            <ul>
                                                <li>عدد المقيمين يصل حتى 3 أشخاص بالغين، وطفل واحد</li>
                                                <li>غرفة بسرير ملكي</li>
                                                <li>غرفة معيشة منفصلة، وجهة مخصصة لتناول الطعام تسع 4 أشخاص</li>
                                                <li>غرفة المكياج</li>
                                            </ul>
                                    </div>
                                    <div class="col">
                                        <ul>
                                                <li>لإطلالة: إطلالة على البوليڤارد وعموم مدينة الرياض من شرفتك الخاصة.</li>
                                                <li>مع جلسة خارجية تسع 4 أشخاص.</li>
                                                <li>المساحة: 106.5 م2</li>
                            ...
                            <div class="row overview justify-content-center align-items-center">
                                <div class="room-full-description">
                                   <ul>
                                        ...
                                        <li>
                                          جهازيّ تلفاز 65 بوصة مع توفر خدمات البث
                                        </li>
                                        <li>
