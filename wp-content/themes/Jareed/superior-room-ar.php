<?php
/*
 * Template Name: Superior Room Arabic
    ...
    <div class="room-banner">
        <div id="boulevard-room-slide"  data-interval="5000" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" style="height:450px;">
                ...
                <img class="" src="<?php echo get_template_directory_uri() ?>/images/SuR 1.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                <img class="" src="<?php echo get_template_directory_uri() ?>/images/SuR 2.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                <img class="" src="<?php echo get_template_directory_uri() ?>/images/SuR 3.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                <img class="" src="<?php echo get_template_directory_uri() ?>/images/SuR 4.jpg" alt="Second slide">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="price-container d-flex">
        <!-- <div class="price d-flex justify-content-between">
            ...
            <img src="<?php echo get_template_directory_uri() ?>/images/LINKS-24.png" alt="" height="30px" width="30px">
                ...
                <p class="text" style="direction:ltr !important;">51 m<sup>2</sup></p>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center">
                <div class="room-details-container">
                    <div class="room-name" style="letter-spacing:normal;"><h2>غرف ستاندرد | الغرف القياسية</h2></div>
                    <div class="room-description">
                    <p>
                    تقدّم لك هذه الغرفة مفهومًا جديدًا للراحة المطلقة. حيث تدمج ما بين التصميم العصري والتفاصيل الفخمة لتبتكر البيئة المثالية التي تتوق للعودة إليها بعد يوم عملٍ طويل.
                    </p>
                    </div>
                    <div class="aboutus-underline"></div>
                    <div class="at-a-glance">
                        <div class="content">
                            <div class="title">لمحة عن الغرفة</div>
                            <div class="points">
                            <div class="row">
                                <div class="col">
                                        <ul>
                                            <li>عدد المقيمين يصل حتى شخصين بالغين، وطفل واحد كحدّ أقصى</li>
                                            <li>سرير ملكي أو سريرين منفصلين</li>
                                            <li>الإطلالة: لا تتوفر إطلالة محددة، فيما تتوفر جلسة خارجية خاصّة</li>
                                        </ul>
                                </div>
                                <div class="col">
                                    <ul>
                                            <li>تتوفر جلسة خارجية خاصّة</li>
                                            <li>المساحة: 52 م2</li>
                                            <li>يتوفر خيار الغرف المتصلة</li>
                                    </ul>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 d-block justify-content-center align-items-center">
                            ...
                            <div class="row overview justify-content-center align-items-center">
                                <div class="room-full-description">
                                   <ul>
                                        <li>
                                          لحد الأقصى المسموح به للأسرّة الإضافية: سرير إضافي -قابل للطيّ- أو  سرير الطفل
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                          مكبر صوت بلوتوث مع منبّه، من علامة أوليفر هيمنج
                                        </li>
                                        <li>
                                          خزنة آمنة
                                        </li>
        ...
        <div class="featured-rooms container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center">
                    ...
                    <div class="title" style="font-family:HelveticaBold;letter-spacing:normal;">الغرف الأخرى</div>
            ...
            <!-- <div class="row" style="padding-right:5%; padding-left:5%;">
                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                    <div class="card">
                        <img src="<?php echo get_template_directory_uri() ?>/images/LINKS-09.png" class="card-img-top" alt="...">
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                    <div class="card">
                        <img src="<?php echo get_template_directory_uri() ?>/images/LINKS-10.png" class="card-img-top" alt="...">
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                    <div class="card">
                        <img src="<?php echo get_template_directory_uri() ?>/images/LINKS-11.png" class="card-img-top" alt="...">
                    </div>
                </div>
            </div> -->
