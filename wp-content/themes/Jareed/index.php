<?php
    ...
    // Rooms and Suites
    $rooms_and_suites = pods('rooms_and_suites');
    $params = array(
    'where' => 't.ID = "475"',
    'limit' => 1
    );
    $rooms_and_suites->find($params);
    $rooms_and_suites_description = $rooms_and_suites->get_field('description');
    ...
    // print_r($spa_and_wellness_facilities); exit;
    // spa wellness old
...
<?php require 'header-home.php';?>
    ...
    <section id="rooms-suits">
        <div class="rooms-suits container-fluid" >
            <div class="row">
                ...
                <div class="title col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center"  data-aos="fade-up"><a href="rooms-&-suites.php">ROOMS</a> &nbsp; & &nbsp;<a href="#suite" class="">SUITES</a></div>
            </div>
            ...
            <div class="row"  data-aos="fade-up">
                <div class="room-contents">
                    <div class="content col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        ...
                        the best sleep of your life. And that’s just the beginning.</p> -->
                            <?php echo $rooms_and_suites_description ;?>
                ...
                <!-- <div class="content col-lg-9 col-md-9 col-sm-9 col-xs-12" >
                    <div class="main-text">
                        ...
                        warmth and elegance, ensuring your feel inspired and well-rested for every
                        moment of your stay.
                        Choose your bedding preferences, find the room scent that soothes you, and get
                        the best sleep of your life. And that’s just the beginning.</p>
                    ...
                    <div class="readmore" >
                        <button type="button" class="btn book-btn">READ MORE</button>
                    </div>
                </div> -->
            </div>
    ...
    <section>
        <div class="restaurant"  >
            ...
            <div class="row" style="padding-left:15px;padding-right:15px;"  data-aos="fade-up">
            ...
            <div class="row morini-banner"  data-aos="fade-up">
                <div id="carouselExampleIndicators3" data-interval="15000" class="carousel slide carousel-fade" data-ride="carousel" data-pause="false">
                    <ol class="carousel-indicators">
                        <?php 
                        $j=0;
                        ...
                        <div class="carousel-item <?php echo ($j==0) ? 'active':'';?>">
                            ...
                            <div class="carousel-caption">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-block justify-content-start" style="margin:0 auto;">
                                        <button class="btn readmore-button"  onclick="location.href = '<?php echo site_url();?>/restaurants';">READ MORE</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section id="spa-wellness">
        <div class="spa-wellness container-fluid">
            ...
            <div class="row"  data-aos="fade-up">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center"  data-aos="fade-up">
                    <div class="rooms-underline-before"></div>
                    <div class="small-title">Rest. Train. Groom</div>
                    <div class="rooms-underline-after"></div>
                </div>
                    <div class="title col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center"  data-aos="fade-up">SPA & WELLNESS</div>
            </div>
            <!-- <div class="row" data-aos="fade-up">
                    ...
                    <div class="spa-image">
                        <div id="jimamCarousel" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                ...
                                <li data-target="#jimamCarousel" data-slide-to="3"></li>
            ...
            <!-- <div class="row" data-aos="fade-up">
                <div class="content2 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <div class="title"><h2><?php echo $jimam_title;?></h2></div>
                    <div class="main-text">
                    ...
                    <div class="readmore">
                        ...
                        <button type="button" class="btn book-btn" onclick="location.href = '<?php echo site_url();?>/spa-wellness#jimam-spa';">READ MORE</button>
                    </div>
                </div>
                ...
                <div class="content col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="arena-image">
                        <div id="arenaCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                       <img src="<?php echo get_template_directory_uri() ?>/images/Arena 1.jpg" class="img-fluid" alt="">   
                                </div>
                                <div class="carousel-item">
                                       <img src="<?php echo get_template_directory_uri() ?>/images/Arena 2.jpg" class="img-fluid" alt="">   
                                </div>
                                <div class="carousel-item">
                                       <img src="<?php echo get_template_directory_uri() ?>/images/Arena 3.jpg" class="img-fluid" alt="">   
                                </div>
                            </div>
                        </div>
            ...
            <!-- <div class="row"  data-aos="fade-up">
                <div class="content2 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <div class="title"><h2><?php echo $arena_title;?></h2></div>
                        <div class="main-text">
                        ...
                        <div class="readmore">
                            ...
                            <button type="button" class="btn book-btn"  onclick="location.href = '<?php echo site_url();?>/spa-wellness#arena-fitness-center';">READ MORE</button>
                        </div>
                    </div>
                    <div class="spa-wellness-logo-container col-lg-3 col-md-12 col-sm-12 col-xs-12">
                    <div class="aboutus-logo">
                        <img src="<?php echo $arena_logo_image;?>" class="" height="100px" alt="">
                    </div>
                </div>
            </div> -->
            <!-- BarberShop -->
                    ...
                    <div class="barbershop-image">
                        <div id="barbershopCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                                          <img src="<?php echo get_template_directory_uri() ?>/images/BARBER 3.jpg" class="img-fluid" alt="">    
            ...
            <!-- <div class="row"  data-aos="fade-up">
                <div class="content2 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <div class="title"><h2><?php echo $barbershop_title;?></h2></div>
                        <div class="main-text">
                        ...
                        <div class="readmore">
                            ...
                            <button type="button" class="btn book-btn" onclick="location.href = 'spa-wellness#barbershop';">READ MORE</button>
                        </div>
                    </div>
                    <div class="spa-wellness-logo-container col-lg-3 col-md-12 col-sm-12 col-xs-12">
                    <div class="aboutus-logo">
            ...
            <div class="row" data-aos="fade-up">
                <div class="content2 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <div class="title"><h2><?php echo $facility['title'];?></h2></div>
                    <div class="main-text">
                    ...
                    <div class="readmore">
                        ...
                        <button type="button" class="btn book-btn" onclick="location.href = '<?php echo site_url();?>/spa-wellness#<?php echo $slug;?>';">READ MORE</button>
                    </div>
                </div>
                <div class="spa-wellness-logo-container col-lg-3 col-md-12 col-sm-12 col-xs-12">
                    <div class="aboutus-logo">
        ...
        <div class="meetings container-fluid"  >
            ...
            <div class="row"  data-aos="fade-up">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center">
                        ...
                        <div class="small-title">Success is a mindset. We’ll help you get there</div>
                        <div class="meetings-underline-after"></div>
                    </div>
                        <div class="title col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center">MEETINGS & GATHERINGS</div>
                </div>
            <div class="row meetings-row" style="padding-left:10%;padding-right:10%"  data-aos="fade-up">
                ...
                <div class="private-office col-lg-8 col-sm-12 col-xs-12 col-md-12">
                        ...
                        <div class="carousel-inner">
                            ...
                            foreach($meetings as $meeting){ ?>
                                <div class="carousel-item <?php echo ($j==0) ? 'active': ''?>">
                                    <div class="private-title"><h2><?php echo $meeting['meetings_title'];?></h2></div>
    ...
    <section>
        <div class="experiences container-fluid"  >
            ...
            <div class="row"  data-aos="fade-up">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center">
                    <div class="rooms-underline-before"></div>
                    <div class="title">EXPERIENCE RIYADH</div>
                    <div class="rooms-underline-after"></div>

                </div>    
            </div>
            <div class="row" style="padding-left:10%;padding-right:10%;"  data-aos="fade-up">
                <?php echo $exp_description;?>
            </div>
            <div class="row exp-img-row" style="padding-left:10%;padding-right:10%;"  data-aos="fade-up">
            <?php
            $j=1;
            ...
            <div class="row" style="padding-left:10%;padding-right:10%;"  data-aos="fade-up">
                <div id="ExpcarouselExampleControls" class="carousel slide" data-ride="carousel" style="background-color:#4b555c;">
                    <ol class="carousel-indicators">
                            <?php 
                    ...
                    <!-- <a class="carousel-control-prev" href="#ExpcarouselExampleControls" role="button" data-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="sr-only">Previous</span>
                    </a>
                    <a class="carousel-control-next" href="#ExpcarouselExampleControls" role="button" data-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    <span class="sr-only">Next</span>
                    </a>
                    <button class="exp-read">READ MORE</button> -->
                </div>
            </div>    
    ...
    <?php require 'footer-secondary-home.php';?>